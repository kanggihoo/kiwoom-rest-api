...
| Header | next-key | 연속조회키 | String | N | 50 | 다음 데이터가 있을시 다음 키값 전달<br>Body dbrt_trde_cntrcnt_su<br>m<br>대차거래체결주수합 String N |
| Body | dbrt_trde_rpy_sum | 대차거래상환주수합 | String | N |  |  |
| Body | rmnd_sum | 잔고주수합 | String | N |  |  |
| Body | remn_amt_sum | 잔고금액합 | String | N |  | Body dbrt_trde_cntrcnt_rt 대차거래체결주수비<br>율<br>String N<br>Body dbrt_trde_rpy_rt 대차거래상환주수비<br>율<br>String N |
| Body | rmnd_rt | 잔고주수비율 | String | N |  |  |
| Body | remn_amt_rt | 잔고금액비율 | String | N |  | Body dbrt_trde_upper_10s<br>tk<br>대차거래상위10종목 LIST N |
