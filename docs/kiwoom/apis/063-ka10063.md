...
| Body | invsr | 투자자별 | String | Y | 1 | 6:외국인, 7:기관계, 1:투신, 0:보험, 2:은행, 3:연기금, 4:국가,<br>5:기타법인 |
...
| Body | - netprps_qty | 순매수수량 | String | N | 20 | Body - prev_pot_netprps_<br>qty<br>이전시점순매수수량 String N 20 |
